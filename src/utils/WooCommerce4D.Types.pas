...
type
  ...
  TEndpointBaseType = (COUPONS, CUSTOMERS, ORDERS, PRODUCTS, PRODUCTS_ATTRIBUTES,
    ...
    REPORTS_SALES, REPORTS_TOP_SELLERS, SHIPPING_METHODS, SHIPPING_ZONES,
  ...
  TAuthType = (BASIC_AUTH, OAUTH_1, NO_AUTH);
...
begin
  case Self of
    ...
    SHIPPING_ZONES: Result := 'shipping/zones';
    SHIPPING_ZONES_METHODS: Result := 'methods';
    TAXES: Result := 'taxes';
